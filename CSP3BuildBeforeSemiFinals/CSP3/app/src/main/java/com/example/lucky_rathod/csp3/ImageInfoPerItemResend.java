...
public class ImageInfoPerItemResend extends Fragment {
    ...
    String completedByResend="Mastek Ngo",completedDateResend ="Feb 17, 2018",completedTimeResend="10 AM";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ((MainActivity) getActivity())
                .setActionBarTitle("Resend Issue Status");
...
/*                String uri = String.format(Locale.ENGLISH, "http://maps.google.com/maps?daddr=%f", imageLocationValues);
        ...
        //Now we will disable resend button


        completedItem.child(currentFirebaseUser.getUid()).child("images").child("resendImages").child(String.valueOf(positon_of_item)).child("completed").addValueEventListener(new ValueEventListener() {
            @Override
                    ...
                    if (dataSnapshot.getValue() != null) {
                        try {
                            ...
                            if(output_of_comleted.equalsIgnoreCase("no")){
                                comleted_or_not_item_text.setText("Reported Resend Issue has not been Completed yet..!");
                                ...
                                comleted_or_not_item_text.setText("Reported Resend Issue has been Completed ..! ");
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("resendImages").child(String.valueOf(positon_of_item)).child("completedDate").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("resendImages").child(String.valueOf(positon_of_item)).child("completedTime").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("resendImages").child(String.valueOf(positon_of_item)).child("completedBy").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("resendImages").child(String.valueOf(positon_of_item)).child("verified").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                                    ...
                                                    if(verifiedOutput.equalsIgnoreCase("no")){
                                                        ...
                                                        okButton.setOnClickListener(new View.OnClickListener() {
                                                            ...
                                                            public void onClick(View view) {
                                                                ...
                                                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("resendImages").child(String.valueOf(positon_of_item)).updateChildren(result);
                                                                Toast.makeText(getActivity(), "Thank you for your Feedback", Toast.LENGTH_SHORT).show();
                                                                feedbackEnteredByUser ="";
                                                                verified_text.setText("Reported Resend Issue has Been Verified .. !");
                                   ...
                                   /*                     //Now here completed is yes and verfied is yes
                                                        ...
                                                        completedItem.child(currentFirebaseUser.getUid()).child("images").child("resendImages").child(String.valueOf(positon_of_item)).addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                ...
                                                                if(retreivedCompleted.equalsIgnoreCase("yes")&&retreivedResend.equalsIgnoreCase("yes")&&retreivedVerified.equalsIgnoreCase("no")){
                                                                    verified_text.setText("Reported Issue has been Resend  succesfully ..!");
                                                                    verified_text.setTextColor(Color.parseColor("#00796B"));
                                                                    ...
                                                                    //Now here completed is yes and verfied is yes
                                                                    //so we will print that Your pothole is successfully verified
                                                                    verified_text.setText("Reported Issue has been Verified and Completed succesfully ..!");
                                                                    verified_text.setTextColor(Color.parseColor("#00796B"));
                                                                    okButton.setAlpha(0.7f);
                                                                    resendButton.setAlpha(0.7f);
                                                                    okButton.setEnabled(false);
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("resendImages").child(String.valueOf(positon_of_item)).child("resend").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                                try {
                                                    final String resendOutput = (String) dataSnapshot.getValue();
...
//                                    editor.commit();
                                                                        ...
                                                                        resendButton.setEnabled(false);
                                                                        resendButton.setAlpha(0.7f);
                                                                        verified_text.setText("Reported Issue has Been RESEND .. !");
                                                                        verified_text.setTextColor(Color.parseColor("#00796B"));
                                                                        okButton.setEnabled(false);
                                                                        okButton.setAlpha(0.7f);
...
//            @Override
//            public void onClick(View view) {
//                Fragment fragment = new ResendFragmentActivity();
