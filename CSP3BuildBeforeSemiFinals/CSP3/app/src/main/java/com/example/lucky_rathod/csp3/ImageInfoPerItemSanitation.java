...
public class ImageInfoPerItemSanitation extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ((MainActivity) getActivity())
                .setActionBarTitle("Sanitation Issue Status");
...
//        Glide.with(getActivity()).load(new File(String.valueOf(imageDownloadUri))).into(final_captured_image);
 ...
 /*               String uri = String.format(Locale.ENGLISH, "http://maps.google.com/maps?daddr=%f", imageLocationValues);
        ...
        completedItem.child(currentFirebaseUser.getUid()).child("images").child("sanitation").child(String.valueOf(positon_of_item)).child("completed").addValueEventListener(new ValueEventListener() {
            @Override
                    ...
                    if (dataSnapshot.getValue() != null) {
                        try {
                            ...
                            if(output_of_comleted.equalsIgnoreCase("no")){
                                comleted_or_not_item_text.setText("Reported Sanitation Issue has not been Completed yet..!");
                                ...
                                comleted_or_not_item_text.setText("Reported Sanitation Issue has been Completed ..! ");
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("sanitation").child(String.valueOf(positon_of_item)).child("completedDate").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("sanitation").child(String.valueOf(positon_of_item)).child("completedTime").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("sanitation").child(String.valueOf(positon_of_item)).child("completedBy").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("sanitation").child(String.valueOf(positon_of_item)).child("verified").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
                                                    ...
                                                    if(verifiedOutput.equalsIgnoreCase("no")){
                                                        ...
                                                        okButton.setOnClickListener(new View.OnClickListener() {
                                                            ...
                                                            public void onClick(View view) {
                                                                ...
                                                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("sanitation").child(String.valueOf(positon_of_item)).updateChildren(result);
                                                                Toast.makeText(getActivity(), "Thank you for your Feedback", Toast.LENGTH_SHORT).show();
                                                                feedbackEnteredByUser ="";
                                                                verified_text.setText("Reported Sanitation Issue has Been Verified .. !");
                                   ...
                                   /*                     //Now here completed is yes and verfied is yes
                                                        ...
                                                        completedItem.child(currentFirebaseUser.getUid()).child("images").child("sanitation").child(String.valueOf(positon_of_item)).addValueEventListener(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                ...
                                                                if(retreivedCompleted.equalsIgnoreCase("yes")&&retreivedResend.equalsIgnoreCase("yes")&&retreivedVerified.equalsIgnoreCase("no")){
                                                                    verified_text.setText("Sanitation Issue has been Resend  succesfully ..!");
                                                                    verified_text.setTextColor(Color.parseColor("#00796B"));
                                                                    ...
                                                                    //Now here completed is yes and verfied is yes
                                                                    //so we will print that Your pothole is successfully verified
                                                                    verified_text.setText("Sanitation Issue has been Verified and Completed succesfully ..!");
                                                                    verified_text.setTextColor(Color.parseColor("#00796B"));
                                                                    okButton.setAlpha(0.7f);
                                                                    resendButton.setAlpha(0.7f);
                                                                    okButton.setEnabled(false);
                                ...
                                completedItem.child(currentFirebaseUser.getUid()).child("images").child("sanitation").child(String.valueOf(positon_of_item)).child("resend").addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        try {
                                            if (dataSnapshot.getValue() != null) {
...
//                                    editor.commit();
                                                                        ...
                                                                        resendButton.setAlpha(0.7f);
                                                                        resendButton.setEnabled(false);
                                                                        verified_text.setText("Sanitation Issue has Been RESEND .. !");
                                                                        verified_text.setTextColor(Color.parseColor("#00796B"));
                                                                        okButton.setAlpha(0.7f);
...
//            @Override
//            public void onClick(View view) {
//                Fragment fragment = new SanitationFragmentActivity();
