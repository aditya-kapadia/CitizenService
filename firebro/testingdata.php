...
<center><h2><strong><a href="solved.php" target="_blank">View Solved Issues</a></strong></h2></center><br><br>
...
rootRef.on("child_added",snap=>{
	...
	$("#pothole-data").show();
	$("#table_body1").append("<tr><td><a href="+url+" target = '_blank' </a>View Image</td> <td>"+add+"</td><td>"+cord+"</td><td>"+wd+"</td><td>"+category+"</td><td>"+date+"</td><td>"+timee+"</td><td><button class = "+testing+" data-id="+testing+">Issue Solved</button></td></tr>");
}
...
$('#table_body1').on('click','button[data-id]',function(e){
	...
	rootRef.child(datakey).update({completedTime:timeis});
	var outputdata;
	var emailidea;
	var coord;
...
*/
		...
		$("#waste-data").show();
	$("#table_body2").append("<tr><td><a href="+url+" target = '_blank' </a>View Image</td> <td>"+add+"</td><td>"+cord+"</td><td>"+wd+"</td><td>"+category+"</td><td>"+date+"</td><td>"+timee+"</td><td><button data-id="+wastetest+">Issue Solved</button></td></tr>");
}
	wastetest++;
});
$('#table_body2').on('click','button[data-id]',function(e){
	...
	rootRef2.child(datakey).update({completedTime:timeis});
var outputdata;
	var emailidea;
	var coord;
